    ...
    constructor(client) {
        super({
            ...
            run: async (client) => {
                ...
                client.logger.log('EventHandler', `Loading a total of ${events.length} events.`, { TitleColor: 'green' });
                ...
                for (const event of events) {
                    ...
                    client.logger.log('EventHandler', `Loading Event: ${e.name}. 👌`, { TitleColor: 'green' });
